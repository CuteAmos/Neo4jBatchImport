 ...
 */
public class NESHModel extends AbstractCsvProduce<ShareHolder> {

    public NESHModel(long start, long end, List<ShareHolder> contents) {
        super(start, end, LabelConstant.NESH.getLabel(),  LabelConstant.NESH.getType(), contents);
    }
